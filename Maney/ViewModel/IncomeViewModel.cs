...
namespace Capuchinos.Maney.ViewModel
{
    public class IncomeViewModel : ViewModelBase
    {
        ...
        public IncomeViewModel()
        {
            ...
            Messenger.Default.Register<NotificationMessage<Transaction>>(this, "EditIncome", EditIncome);
        ...
        private void EditIncome(NotificationMessage<Transaction> transaction)
        {
        ...
        private async void Save()
        {
            ...
            var t = new Transaction
            {
                ...
                TransactionType = (short)TransactionType.Income,
